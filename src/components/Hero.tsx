  ...
  <section className="relative pt-28 pb-12 px-5 min-h-[100svh] flex flex-col items-center justify-center text-center overflow-hidden">
    ...
    >
      ...
      <div className="space-y-1.5">
        ...
        <p className="text-[11px] uppercase tracking-[0.3em] text-brand-dark/60 font-medium">por Patricia Pietrasanta</p>
      </div>
      ...
      <div className="space-y-5">
        ...
        <p className="text-sm md:text-base font-light text-brand-dark/75 max-w-xl mx-auto leading-relaxed">
